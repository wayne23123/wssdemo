...
// 呼叫 orderUndoFunction，從 Vuex store 中取得訂單
adminCartStore.ordeUndorFunction;
...
<template>
  <div class="pageOneLayOut">
    ...
    <div
      ...
      class="dataButton"
    >
      <div @click="adminCartStore.reverseOrderUndoRefs" class="dataButtonOrder">
        訂單編號▼
      </div>
    ...
    <div class="dataLayout">
      ...
      >
        ...
        <div v-if="adminCartStore.orderUndoSearchTermRef.length < 1">
